...
import { AvatarSelector, AVATAR_EMOJIS_LIST } from '../components/AvatarSelector';
...
export function Profile() {
  ...
  const handleSave = async () => {
    ...
    try {
      await updateProfile.mutateAsync({ name: editName.trim(), avatarId: BigInt(editAvatarId) });
      ...
      {isLoading ? (
        ...
        <>
            ...
            {!isEditing ? (
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 font-mono">{principalShort}</p>
                  <button
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <AvatarSelector selectedAvatarId={editAvatarId} onSelect={setEditAvatarId} />
                </div>
                <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    onClick={() => { setIsEditing(false); setEditName(profile.name); setEditAvatarId(Number(profile.avatarId)); }}
                    variant="outline"
                    size="sm"
                    className="rounded-xl"
                  >
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-bold text-foreground uppercase tracking-wider">Your Stats</h2>
            <ProfileStats profile={profile} />
          </div>

          {/* Quick Links */}
          <div className="space-y-2">
            <h2 className="text-sm font-bold text-foreground uppercase tracking-wider">More</h2>
            {[
