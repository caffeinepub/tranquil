    ...
    <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="flex items-center justify-between px-4 py-3 max-w-[430px] mx-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold font-display tracking-tight text-foreground">TRANQUIL</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`p-2 rounded-xl transition-colors ${
              location.pathname === '/tips' ? 'bg-primary/15 text-primary' : 'hover:bg-muted text-muted-foreground'
            }`}
            title="AI Tips"
          >
          ...
          <button
            ...
            className={`p-2 rounded-xl transition-colors ${
              location.pathname === '/profile' ? 'bg-primary/15 text-primary' : 'hover:bg-muted text-muted-foreground'
            }`}
          >
          ...
          <button
            ...
            className={`p-2 rounded-xl transition-colors ${
              location.pathname === '/settings' ? 'bg-primary/15 text-primary' : 'hover:bg-muted text-muted-foreground'
            }`}
          >
