    ...
    <div className="px-4 py-5 space-y-6 animate-fade-in-up">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Customize your TRANQUIL experience
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <button
          type="button"
          data-ocid="settings.privacy_nav.button"
          onClick={() => navigate({ to: "/privacy" })}
          className="w-full flex items-center justify-between p-4 bg-card rounded-2xl border border-border hover:bg-accent/50 transition-colors"
        >
          <div className="flex items-center gap-3">
      ...
      <div className="space-y-3">
        ...
        <div className="p-5 bg-card rounded-2xl border border-border space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            TRANQUIL is your personal stress relief companion designed for
            students, working professionals, and anyone dealing with daily
            stress. Monitor your wellness, practice breathing exercises, track
            your mood, and find your calm — all in one place.
          </p>
